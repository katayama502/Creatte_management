    ...
    <>
      ...
      <aside
        className={cn(
          ...
          // Mobile: fixed overlay, off-screen by default, slides in when open
      ...
      >
        ...
        >
          ...
          {!collapsed && (
            <button
              onClick={close}
              className="md:hidden flex items-center justify-center w-7 h-7 rounded-lg text-brand-300 hover:text-white hover:bg-white/10 transition-colors shrink-0"
